...
/**
 * Read-only pointer to HireFlow's tbl_manpower_request_position (portal_db,
...
class HireflowManpowerPosition extends Model
{
    ...
    /**
     * Job spec is looked up via query builder (DB::table(...)) rather than a
     * dedicated Eloquent model, per your confirmed preference — mirrors how
     * HireFlow itself queries MP_JOBSPEC_TABLE.
     */
    public function jobSpec()
    {
        return \Illuminate\Support\Facades\DB::table('tbl_manpower_jobspec')
